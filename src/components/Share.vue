  ...
  methods: {
    shareToFb() {
      window.ga('newmedia.send', {
        ...
        eventCategory: 'Share',
        eventAction: 'click',
        eventLabel: `[${detectPlatform()}] [${document.querySelector('title').innerHTML}] [Click_FB_botton]`,
      });
    },
    shareToLine() {
      if (detectMob()) {
      ...
      window.ga('newmedia.send', {
        ...
        eventCategory: 'Share',
        eventAction: 'click',
        eventLabel: `[${detectPlatform()}] [${document.querySelector('title').innerHTML}] [Click_Line_botton]`,
      });
    },
  },
  created() {
